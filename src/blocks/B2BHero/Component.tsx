...
import type { B2BHeroBlock as B2BHeroBlockProps } from '@/payload-types'
import { CMSLink } from '@/components/Link'
import RichText from '@/components/RichText'
import { CheckCircle2 } from 'lucide-react'

export const B2BHeroBlock: React.FC<B2BHeroBlockProps> = ({
  heading,
  subheading,
  primaryCTA,
  secondaryCTA,
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-secondary py-20 md:py-28 lg:py-36">
